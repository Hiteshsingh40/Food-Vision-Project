...
# Creating tensor board callbacks
import datetime
...
def compare_historys(original_history, new_history, initial_epochs=5):
    ...
    plt.plot(total_val_acc, label='Validation Accuracy', c='b', marker='*', linestyle='dashed')
    plt.plot([initial_epochs-1, initial_epochs-1],
              plt.ylim(), label='Start Fine Tuning', c='g', linestyle='dashed') # reshift plot around epochs
    ...
    plt.plot(total_val_loss, label='Validation Loss', c='g', marker='*', linestyle='dashed')
    plt.plot([initial_epochs-1, initial_epochs-1],
              plt.ylim(), label='Start Fine Tuning', c='b', linestyle='dashed') # reshift plot around epochs
